          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        {...field}
                        className="pl-12 text-content-secondary"
                      />
                    </div>
                  </FormControl>
                  <FormMessage />
                    ...
                    <div className="relative">
                      ...
                      <IMaskInput
                        ...
                        className="
                          ...
                          placeholder:text-content-secondary text-content-secondary
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      className="resize-none text-content-secondary"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <div className="space-y-4 md:grid md:grid-cols-2 md:gap-4 md:space-y-0">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-label-medium-size text-context-primary">
                      Hora
                    </FormLabel>
                    <FormControl>
                      <Select
                        ...
                        value={field.value}
                      >
                        <SelectTrigger className="text-content-secondary">
